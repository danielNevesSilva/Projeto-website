...
@WebServlet("/product-detailsPrincipal")
public class ListProductsDetailsPrincipalServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        request.getRequestDispatcher("DetalhesPrincipal.jsp").forward(request, response);
    }
}
